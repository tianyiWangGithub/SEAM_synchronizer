...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/synchronizer/results/validation_seam_success_rate/Tw_Tb/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/synchronizer/results/validation_computetime/Tw_Tb/data_ct_ratio.txt")

...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/synchronizer/results/validation_seam_success_rate/C/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/synchronizer/results/validation_computetime/C/data_ct_C.txt")

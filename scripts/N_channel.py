...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/synchronizer/results/validation_seam_success_rate/channel_num/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/synchronizer/results/validation_computetime/channel/data_ct_N.txt")
